...
{
    /// <inheritdoc />
    public partial class ActiveDevices : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlagIcon = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    DisplayOrder = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QrCodeGeneratedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NarrationId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LocationId = table.Column<int>(type: "integer", nullable: false),
                    LanguageId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Các điểm tham quan...", 1, "fa-landmark", true, "Điểm tham quan" },
                    { 2, "Nhà hàng...", 2, "fa-utensils", true, "Địa điểm ăn uống" },
                    { 3, "Các sự kiện...", 3, "fa-calendar-alt", true, "Sự kiện" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "vi", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 1, "flag-icon-vn", true, "Tiếng Việt" },
                    { 2, "en", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 2, "flag-icon-us", true, "English" },
                    { 3, "zh", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 3, "flag-icon-cn", true, "中文" },
                    { 4, "ko", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 4, "flag-icon-kr", true, "한국어" },
                    { 5, "ja", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 5, "flag-icon-jp", true, "日本語" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "CreatedDate", "Email", "FullName", "IsActive", "LastLoginDate", "PasswordHash", "Phone", "Role", "Username" },
                values: new object[] { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@pltour.com", "Administrator", true, null, "$2a$11$9yp8l6nskdBY8FSI7z.wcOz59amVosuE5psxh.DyxiYE0rRvKH45C", "0123456789", "Admin", "admin" });
